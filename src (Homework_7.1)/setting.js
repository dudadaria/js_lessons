...
class Settings {
   ...
   * @param {number} params.winLength - какую длину нужно наесть чтобы выиграть.
   * @throws {Error} если переданы не верные настройки выбрасывается соответствующая ошибка
   */
